...
export const baseURL = import.meta.env.VITE_APP_URL + '/user/files';
export const file_download = baseURL + '/download?files=';
...
export const form_default = {
  ...
  articleAddress: [],
  articleAddressDetail: '河南科技大学应用工程学院',
  articleCategory: [],
  articlePrice: 6.66,
  userIndex: 1,
};
//物品类别的option
export const item_options: IOptions[] = [
  {
    value: 1,
    label: '数码',
  },
